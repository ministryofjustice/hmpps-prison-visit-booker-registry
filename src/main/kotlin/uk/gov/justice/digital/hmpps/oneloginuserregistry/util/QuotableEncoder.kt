package uk.gov.justice.digital.hmpps.oneloginuserregistry.util

import kotlin.random.Random

class QuotableEncoder(private val delimiter: String = "-", private val minLength: Int = 1, private val chunkSize: Int = 4) {
