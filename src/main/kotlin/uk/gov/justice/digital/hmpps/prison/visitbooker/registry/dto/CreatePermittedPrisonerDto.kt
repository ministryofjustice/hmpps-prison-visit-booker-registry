...
@Schema(description = "Create permittedPrisoner with permittedVisitors associated with the booker.")
data class CreatePermittedPrisonerDto(
  ...
  @Schema(name = "visitorIds", description = "list of permittedVisitors for permittedPrisoner", required = true)
  @field:NotEmpty
